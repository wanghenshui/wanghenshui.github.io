...
{% include_relative mermaid-fragment.html source="mmd/simple.mmd" %}


 Variant 2

{% include_relative mermaid-fragment.html source="mmd/v2.mmd" %}

 Medium

 {% include_relative mermaid-fragment.html source="mmd/m.mmd" %}



{% include_relative mermaid-fragment.html source="mmd/flowchart.mmd" %}


{% include_relative mermaid-fragment.html source="mmd/sequence.mmd" %}

{% include_relative mermaid-fragment.html source="mmd/gantt.mmd" %}

{% include_relative mermaid-fragment.html source="mmd/class.mmd" %}
