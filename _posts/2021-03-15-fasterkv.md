...
- Recover
  ...
  -  校验checkpoint\_.log_metadata.version == checkpoint_.index_metadata.version
...
具体删除文件在TruncateSegments里，通过epoch_->BumpCurrentEpoch(callback, context_copy);去删除文件
